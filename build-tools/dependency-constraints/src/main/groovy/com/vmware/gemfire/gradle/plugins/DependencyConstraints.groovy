 ...
 * buildscript {} configuration in the root project's build.gradle. */
  ...
  static private Map<String, String> initExternalDependencies() {
    ...
    depVersionMapping.put("log4jVersion", "2.17.2")
    depVersionMapping.put("logbackVersion", "1.2.3")
    depVersionMapping.put("junitVersion", "4.13.2")
    depVersionMapping.put("mockitoVersion", "4.5.1")
    ...
    depVersionMapping.put("springDataBomVersion","2021.2.5")
    depVersionMapping.put("springDataCommonsVersion","2.7.5")
    depVersionMapping.put("springDataGeodeVersion","2.7.5")
    depVersionMapping.put("sdgtVersion","0.3.4-RAJ")
    depVersionMapping.put("springSessionVersion","2.7.0")
    depVersionMapping.put("multithreadedtcVersion","1.01")
    depVersionMapping.put("apacheLogging","2.14.1")
    depVersionMapping.put("springSessionDataGeode","2.7.1")
