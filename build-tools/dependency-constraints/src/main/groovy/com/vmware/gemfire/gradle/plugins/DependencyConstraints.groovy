 ...
 * buildscript {} configuration in the root project's build.gradle. */
  ...
  static private Map<String, String> initExternalDependencies() {
    ...
    depVersionMapping.put("springVersion","6.0.3")
    depVersionMapping.put("springBootVersion","3.0.0")
    depVersionMapping.put("springDataCommonsVersion","3.0.0")
    depVersionMapping.put("stgVersion","1.0.0-build.1")
    depVersionMapping.put("springSessionVersion","3.0.0")
    depVersionMapping.put("multithreadedtcVersion","1.01")
  ...
  void apply(Project project) {
    ...
    project.dependencies {
      ...
      constraints {
        ...
        api(group: 'com.vmware.gemfire', name: 'spring-test-gemfire-10.0-3.0', version: get('stgVersion'))
